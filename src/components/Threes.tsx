...
type GLTFResult = GLTF & { nodes: { Cylinder017: THREE.Mesh,Cylinder017_1: THREE.Mesh }
materials: {    ['GreenDark.003']: THREE.MeshStandardMaterial,['BrownDark.035']: THREE.MeshStandardMaterial}}

export default function Model17(props: JSX.IntrinsicElements['group']) {
    const group = useRef<THREE.Group>()
    const { nodes, materials } = useGLTF('https://vazxmixjsiawhamofees.supabase.co/storage/v1/object/public/models/tree-kaykit-2/model.gltf') as GLTFResult
    return (
